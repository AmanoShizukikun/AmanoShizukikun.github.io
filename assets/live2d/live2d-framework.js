/*和index2.js一樣*/
import { l as t } from "./waifu-tips.js";
class e {
  constructor(t = 0) {
    t < 1
  ...
  pushBack(t) {
    this._size >= this._capacity &&
      this.prepareCapacity(
        0 == this._capacity ? e.DefaultSize : 2 * this._capacity
      ),
  ...
  remove(t) {
    return (
      !(t < 0 || this._size <= t) && (this._ptr.splice(t, 1), --this._size, !0)
    );
  }
  erase(t) {
    const e = t._index;
    if (e < 0 || this._size <= e) return t;
    this._ptr.splice(e, 1), --this._size;
    return new i(this, e);
  }
  prepareCapacity(t) {
    t > this._capacity &&
  ...
  getOffset(t) {
    ...
    return (
      (i._ptr = this.get(t)),
      (i._size = this.get(t).length),
      (i._capacity = this.get(t).length),
      i
    );
  }
}
  ...
  registerId(t) {
    ...
    return "string" != typeof t
      ...
      : (null != (e = this.findId(t)) ||
          ((e = d.createIdInternal(t)), this._ids.pushBack(e)),
        e);
  }
  getId(t) {
...
class p {
  ...
  constructor() {
    (this._isCulling = !1),
      ...
      (this._anisotropy = 0),
      (this._model = null),
      (this._modelColor = new f()),
      (this._useHighPrecisionMask = !1),
      (this._mvpMatrix4x4 = new c()),
...
class y {
  constructor(t, e) {
    (this._clippingIdList = t),
      ...
      (this._allClippedDrawRect = new m()),
      (this._layoutBounds = new m()),
      (this._clippedDrawableIndexList = []),
      (this._matrixForMask = new c()),
      (this._matrixForDraw = new c()),
      (this._bufferIndex = 0);
  }
  release() {
  ...
  appendKey(t) {
    ...
    -1 == e
      ? (this.prepareCapacity(this._size + 1, !1),
        (this._keyValues[this._size] = new F(t)),
        (this._size += 1))
      : v("The key `{0}` is already append.", t);
  }
  getValue(t) {
    let e = -1;
    for (let i = 0; i < this._size; i++)
  ...
  prepareCapacity(t, e) {
    t > this._keyValues.length &&
      (0 == this._keyValues.length
        ? (!e && t < I.DefaultSize && (t = I.DefaultSize),
...
class V {
  ...
  decrement() {
    const t = new V(this._map, this._index);
      ...
      Object.keys(t).forEach((i) => {
        if ("boolean" == typeof t[i]) {
          ...
          t[i] instanceof Array
            ? e.put(i, E.parseJsonArray(t[i]))
            : t[i] instanceof Object
            ? e.put(i, E.parseJsonObject(t[i], new U()))
            : null == t[i]
            ? e.put(i, new N())
            : e.put(i, t[i]);
      }),
...
class L {
  constructor(t, e) {
    (this._parseCallback = E.parseJsonObject),
      (this._error = null),
      (this._lineCount = 0),
      (this._root = null),
  ...
  parseBytes(t, e, i) {
    ...
    if (
      ((this._root =
        null == i ? this.parseValue(r, e, 0, s) : i(JSON.parse(r), new U())),
      this._error)
    ) {
      let t = "\0";
      return (
        ...
        (this._root = new O(t)),
        M("{0}", this._root.getRawString()),
        !1
      );
    }
    return (
      null != this._root || ((this._root = new k(new g(this._error), !1)), !1)
    );
  }
  getParseError() {
    return this._error;
  ...
  parseValue(t, e, i, s) {
    ...
    for (; n < e; n++) {
      switch (t[n]) {
        ...
        case "9": {
          const e = new Array(1);
          return (r = X(t.slice(n), e)), (s[0] = t.indexOf(e[0])), new D(r);
        }
        case '"':
  ...
  parseString(t, e, i, s) {
    ...
    for (; n < e; n++)
      switch (((r = t[n]), r)) {
        ...
        case "//":
          if (
            (n++, n - 1 > l && o.append(t.slice(l), n - l), (l = n + 1), n < e)
          )
            switch (((a = t[n]), a)) {
              case "\\":
                o.expansion(1, "\\");
  ...
  parseObject(t, e, i, s) {
    ...
    for (; n < e; n++) {
      t: for (; n < e; n++)
        switch (((o = t[n]), o)) {
          case '"':
            if (((a = this.parseString(t, e, n + 1, l)), this._error))
              return null;
            (n = l[0]), (h = !0);
            break t;
          case "}":
...
class U extends T {
  ...
  getValueByString(t) {
    ...
    for (
      ...
      if (e.ptr().first == t)
        return null == e.ptr().second ? T.nullValue : e.ptr().second;
    return T.nullValue;
  }
  getValueByIndex(t) {
    return T.errorValue.setErrorNotForClientCall(R);
...
let Y = !1,
  ...
  H = null,
  q = null;
const W = Object.freeze({ vertexOffset: 0, vertexStep: 2 });
function J(t) {
  t && (t = void 0);
}
class $ {
  static startUp(t = null) {
    ...
    if (
      ((H = t),
      null != H && Live2DCubismCore.Logging.csmSetLogFunction(H.logFunction),
      (Y = !0),
      Y)
    ) {
  ...
  static initialize(t = 0) {
    C(Y),
      Y
        ? j
          ? v("CubismFramework.initialize() skipped, already initialized.")
          : (T.staticInitializeNotForClientCall(),
            (q = new _()),
            Live2DCubismCore.Memory.initializeAmountOfMemory(t),
            (j = !0),
            M("CubismFramework.initialize() is complete."))
        : v("CubismFramework is not started.");
  }
  static dispose() {
    C(Y),
      Y
        ? j
          ? (T.staticReleaseNotForClientCall(),
            ...
            p.staticRelease(),
            (j = !1),
            M("CubismFramework.dispose() is complete."))
          : v("CubismFramework.dispose() skipped, not initialized.")
        : v("CubismFramework is not started.");
  }
  static isStarted() {
    return Y;
...
class nt {
  ...
  initialize(t) {
    // Create WebGL context with preserveDrawingBuffer so canvas content can be captured via toDataURL()
    this._gl = t.getContext("webgl2", { preserveDrawingBuffer: true }) || t.getContext("webgl", { preserveDrawingBuffer: true });
    if (!this._gl) {
...
!(function (t) {
  (t.HitAreaBody = ot.HitAreaBody),
    (t.HitAreaHead = ot.HitAreaHead),
    (t.HitAreaPrefix = ot.HitAreaPrefix),
    (t.ParamAngleX = ot.ParamAngleX),
    (t.ParamAngleY = ot.ParamAngleY),
    (t.ParamAngleZ = ot.ParamAngleZ),
    (t.ParamArmLA = ot.ParamArmLA),
    (t.ParamArmLB = ot.ParamArmLB),
    (t.ParamArmRA = ot.ParamArmRA),
    (t.ParamArmRB = ot.ParamArmRB),
    (t.ParamBaseX = ot.ParamBaseX),
    (t.ParamBaseY = ot.ParamBaseY),
    (t.ParamBodyAngleX = ot.ParamBodyAngleX),
    (t.ParamBodyAngleY = ot.ParamBodyAngleY),
    (t.ParamBodyAngleZ = ot.ParamBodyAngleZ),
    (t.ParamBreath = ot.ParamBreath),
    (t.ParamBrowLAngle = ot.ParamBrowLAngle),
    (t.ParamBrowLForm = ot.ParamBrowLForm),
    (t.ParamBrowLX = ot.ParamBrowLX),
    (t.ParamBrowLY = ot.ParamBrowLY),
    (t.ParamBrowRAngle = ot.ParamBrowRAngle),
    (t.ParamBrowRForm = ot.ParamBrowRForm),
    (t.ParamBrowRX = ot.ParamBrowRX),
    (t.ParamBrowRY = ot.ParamBrowRY),
    (t.ParamBustX = ot.ParamBustX),
    (t.ParamBustY = ot.ParamBustY),
    (t.ParamCheek = ot.ParamCheek),
    (t.ParamEyeBallForm = ot.ParamEyeBallForm),
    (t.ParamEyeBallX = ot.ParamEyeBallX),
    (t.ParamEyeBallY = ot.ParamEyeBallY),
    (t.ParamEyeLOpen = ot.ParamEyeLOpen),
    (t.ParamEyeLSmile = ot.ParamEyeLSmile),
    (t.ParamEyeROpen = ot.ParamEyeROpen),
    (t.ParamEyeRSmile = ot.ParamEyeRSmile),
    (t.ParamHairBack = ot.ParamHairBack),
    (t.ParamHairFluffy = ot.ParamHairFluffy),
    (t.ParamHairFront = ot.ParamHairFront),
    (t.ParamHairSide = ot.ParamHairSide),
    (t.ParamHandL = ot.ParamHandL),
    (t.ParamHandR = ot.ParamHandR),
    (t.ParamMouthForm = ot.ParamMouthForm),
    (t.ParamMouthOpenY = ot.ParamMouthOpenY),
    (t.ParamNONE = ot.ParamNONE),
    (t.ParamShoulderY = ot.ParamShoulderY),
    (t.PartsArmLPrefix = ot.PartsArmLPrefix),
    (t.PartsArmPrefix = ot.PartsArmPrefix),
    (t.PartsArmRPrefix = ot.PartsArmRPrefix),
    (t.PartsIdCore = ot.PartsIdCore);
})(lt || (lt = {}));
class mt {}
((ht || (ht = {})).ICubismModelSetting = mt),
  (function (t) {
...
class pt extends mt {
  constructor(t, i) {
    super(),
      ...
      (this.val = "val"),
      (this._json = L.create(t, i)),
      this.getJson() &&
        ((this._jsonValue = new e()),
  ...
  getModelFileName() {
    return this.isExistModelFile()
      ? this._jsonValue.at(ut.FrequestNode_Moc).getRawString()
      : "";
  }
  getTextureCount() {
    return this.isExistTextureFiles()
      ? this._jsonValue.at(ut.FrequestNode_Textures).getSize()
      : 0;
  }
  getTextureDirectory() {
    const t = this._jsonValue
        .at(ut.FrequestNode_Textures)
        .getValueByIndex(0)
        .getRawString()
        .split("/"),
      e = t.length - 1;
  ...
  getHitAreasCount() {
    return this.isExistHitAreas()
      ? this._jsonValue.at(ut.FrequestNode_HitAreas).getSize()
      : 0;
  }
  getHitAreaId(t) {
    return $.getIdManager().getId(
      this._jsonValue
        .at(ut.FrequestNode_HitAreas)
        .getValueByIndex(t)
  ...
  getPhysicsFileName() {
    return this.isExistPhysicsFile()
      ? this._jsonValue.at(ut.FrequestNode_Physics).getRawString()
      : "";
  }
  getPoseFileName() {
    return this.isExistPoseFile()
      ? this._jsonValue.at(ut.FrequestNode_Pose).getRawString()
      : "";
  }
  getExpressionCount() {
    return this.isExistExpressionFile()
      ? this._jsonValue.at(ut.FrequestNode_Expressions).getSize()
      : 0;
  }
  getExpressionName(t) {
    return this._jsonValue
      .at(ut.FrequestNode_Expressions)
      .getValueByIndex(t)
      .getValueByString(this.name)
      .getRawString();
  }
  ...
  getMotionGroupCount() {
    return this.isExistMotionGroups()
      ? this._jsonValue.at(ut.FrequestNode_Motions).getKeys().getSize()
      : 0;
  }
  getMotionGroupName(t) {
    return this.isExistMotionGroups()
      ? this._jsonValue.at(ut.FrequestNode_Motions).getKeys().at(t)
      : null;
  }
  getMotionCount(t) {
    return this.isExistMotionGroupName(t)
      ? this._jsonValue
          .at(ut.FrequestNode_Motions)
          .getValueByString(t)
          .getSize()
      : 0;
  }
  ...
  getEyeBlinkParameterCount() {
    ...
    for (
      let e = 0;
      e < this._jsonValue.at(ut.FrequestNode_Groups).getSize();
      e++
    ) {
      const i = this._jsonValue.at(ut.FrequestNode_Groups).getValueByIndex(e);
      if (
        !i.isNull() &&
        !i.isError() &&
  ...
  isExistModelFile() {
    const t = this._jsonValue.at(ut.FrequestNode_Moc);
    return !t.isNull() && !t.isError();
  }
  isExistTextureFiles() {
    const t = this._jsonValue.at(ut.FrequestNode_Textures);
    return !t.isNull() && !t.isError();
  }
  isExistHitAreas() {
    const t = this._jsonValue.at(ut.FrequestNode_HitAreas);
    return !t.isNull() && !t.isError();
  }
  isExistPhysicsFile() {
    const t = this._jsonValue.at(ut.FrequestNode_Physics);
    return !t.isNull() && !t.isError();
  }
  isExistPoseFile() {
    const t = this._jsonValue.at(ut.FrequestNode_Pose);
    return !t.isNull() && !t.isError();
  }
  isExistExpressionFile() {
    const t = this._jsonValue.at(ut.FrequestNode_Expressions);
    return !t.isNull() && !t.isError();
  }
  isExistMotionGroups() {
    const t = this._jsonValue.at(ut.FrequestNode_Motions);
    return !t.isNull() && !t.isError();
  }
  isExistMotionGroupName(t) {
    const e = this._jsonValue.at(ut.FrequestNode_Motions).getValueByString(t);
  ...
  isExistEyeBlinkParameters() {
    if (
      this._jsonValue.at(ut.FrequestNode_Groups).isNull() ||
      this._jsonValue.at(ut.FrequestNode_Groups).isError()
    )
      return !1;
    for (
      let t = 0;
      t < this._jsonValue.at(ut.FrequestNode_Groups).getSize();
      ++t
    )
      if (
        this._jsonValue
          .at(ut.FrequestNode_Groups)
          .getValueByIndex(t)
          .getValueByString(this.name)
...
class ft {
  ...
  updateParameters(t, e) {
    this._currentTime += e;
    const i = 2 * this._currentTime * Math.PI;
...
class St {
    ...
    switch (this._blinkingState) {
      case _t.EyeState_Closing:
        (s =
          ...
          s >= 1 &&
            ((s = 1),
            (this._blinkingState = _t.EyeState_Closed),
      ...
      case _t.EyeState_Closed:
        (s =
          ...
          this._closedSeconds),
          s >= 1 &&
            ((this._blinkingState = _t.EyeState_Opening),
            (this._stateStartTimeSeconds = this._userTimeSeconds)),
          (i = 0);
        break;
      case _t.EyeState_Opening:
        (s =
          ...
          s >= 1 &&
            ((s = 1),
            (this._blinkingState = _t.EyeState_Interval),
            (this._nextBlinkingTime = this.determinNextBlinkingTiming())),
          (i = s);
        break;
      case _t.EyeState_Interval:
        this._nextBlinkingTime < this._userTimeSeconds &&
          ((this._blinkingState = _t.EyeState_Closing),
          (this._stateStartTimeSeconds = this._userTimeSeconds)),
          (i = 1);
        break;
  ...
  constructor(t) {
    if (
      ((this._blinkingState = _t.EyeState_First),
...
class Mt {
  static create(t, e) {
    ...
    const s = new Mt(),
      r = i.getRoot();
    r.getValueByString(Ct).isNull() ||
      ((s._fadeTimeSeconds = r.getValueByString(Ct).toFloat(0.5)),
      s._fadeTimeSeconds < 0 && (s._fadeTimeSeconds = 0.5));
    ...
    for (let t = 0; t < n; ++t) {
      ...
      let r = 0;
      for (let t = 0; t < i; ++t) {
        const i = e.getValueByIndex(t),
          a = new vt(),
          n = $.getIdManager().getId(i.getValueByString("Id").getRawString());
        if (((a.partId = n), !i.getValueByString(xt).isNull())) {
          const t = i.getValueByString(xt),
            e = t.getSize();
          for (let i = 0; i < e; ++i) {
            const e = new vt(),
              s = $.getIdManager().getId(t.getValueByIndex(i).getString());
            (e.partId = s), a.link.pushBack(e);
          }
        }
        s._partGroups.pushBack(a.clone()), ++r;
      }
      s._partGroupCounts.pushBack(r);
    }
    return L.delete(i), s;
  }
  static delete(t) {}
  ...
  doFade(t, e, i, s) {
    ...
    for (let n = i; n < i + s; ++n) {
      ...
      if (t.getParameterValueByIndex(s) > 0.001) {
        if (r >= 0) break;
        if (((r = n), 0 == this._fadeTimeSeconds)) {
          a = 1;
          continue;
        }
  ...
  constructor() {
    (this._fadeTimeSeconds = 0.5),
      ...
      (this._partGroups = new e()),
      (this._partGroupCounts = new e());
  }
}
class vt {
  constructor(t) {
...
class Vt {
  ...
  static quadraticEquation(t, e, i) {
    return this.abs(t) < Vt.Epsilon
      ? this.abs(e) < Vt.Epsilon
        ? -i
        : -i / e
      : -(e + this.sqrt(e * e - 4 * t * i)) / (2 * t);
  }
  static cardanoAlgorithmForBezier(t, e, i, s) {
    if (this.abs(t) < Vt.Epsilon)
    ...
    if (u < 0) {
      const t = -n / 3,
        ...
        o = Math.acos(a),
        h = 2 * this.cbrt(i),
        u = h * this.cos(o / 3) - r / 3;
      if (this.abs(u - g) < d) return this.range(u, 0, 1);
      const _ = h * this.cos((o + 2 * Math.PI) / 3) - r / 3;
      if (this.abs(_ - g) < d) return this.range(_, 0, 1);
      const c = h * this.cos((o + 4 * Math.PI) / 3) - r / 3;
    ...
    if (0 == u) {
      ...
      const e = 2 * t - r / 3;
      if (this.abs(e - g) < d) return this.range(e, 0, 1);
      const i = -t - r / 3;
  ...
  static mod(t, e) {
    if (!isFinite(t) || 0 === e || isNaN(t) || isNaN(e))
      return (
        console.warn(`divided: ${t}, divisor: ${e} mod() returns 'NaN'.`), NaN
      );
    const i = Math.abs(t),
      s = Math.abs(e);
    let r = i - Math.floor(i / s) * s;
...
class Et {
  ...
  update(t) {
    ...
    if (Vt.abs(r) <= 0.01 && Vt.abs(a) <= 0.01) return;
    const n = Vt.sqrt(r * r + a * a),
      o = (e * a) / n;
    let l = (e * r) / n - this._faceVX,
      h = o - this._faceVY;
    const u = Vt.sqrt(l * l + h * h);
    (u < -s || u > s) && ((l *= s / u), (h *= s / u)),
      (this._faceVX += l),
      (this._faceVY += h);
    {
      const t = 0.5 * (Vt.sqrt(s * s + 16 * s * n - 8 * s * n) - s),
        e = Vt.sqrt(this._faceVX * this._faceVX + this._faceVY * this._faceVY);
    ...
    return (
      (i =
        ...
        (0 == this._fadeInSeconds
          ? 1
          : Vt.getEasingSine(
              (e - t.getFadeInStartTime()) / this._fadeInSeconds
            )) *
        (0 == this._fadeOutSeconds || t.getEndTime() < 0
          ? 1
          : Vt.getEasingSine((t.getEndTime() - e) / this._fadeOutSeconds))),
      t.setState(e, i),
      C(0 <= i && i <= 1),
      i
    );
...
class Ot extends Lt {
  ...
  calculateExpressionParameters(t, e, i, s, r, a) {
    if (null != i && null != s && i.isAvailable()) {
      this._fadeWeight = this.updateFadeWeight(i, e);
      for (let e = 0; e < s.getSize(); ++e) {
        const i = s.at(e);
        if (null == i.parameterId) continue;
        const n = (i.overwriteValue = t.getParameterValueById(i.parameterId)),
          o = this.getExpressionParameters();
        let l = -1;
        for (let t = 0; t < o.getSize(); ++t)
          if (i.parameterId == o.at(t).parameterId) {
            l = t;
            break;
          }
        if (l < 0) {
          0 == r
            ? ((i.additiveValue = Ot.DefaultAdditiveValue),
              (i.multiplyValue = Ot.DefaultMultiplyValue),
              (i.overwriteValue = n))
            : ((i.additiveValue = this.calculateValue(
                i.additiveValue,
                Ot.DefaultAdditiveValue,
                a
              )),
              (i.multiplyValue = this.calculateValue(
                i.multiplyValue,
                Ot.DefaultMultiplyValue,
                a
              )),
              (i.overwriteValue = this.calculateValue(i.overwriteValue, n, a)));
          continue;
        }
        const h = o.at(l).value;
        let u, g, d;
        switch (o.at(l).blendType) {
          case kt.Additive:
            (u = h), (g = Ot.DefaultMultiplyValue), (d = n);
            break;
          case kt.Multiply:
            (u = Ot.DefaultAdditiveValue), (g = h), (d = n);
            break;
          case kt.Overwrite:
            (u = Ot.DefaultAdditiveValue),
              (g = Ot.DefaultMultiplyValue),
              (d = h);
            break;
          default:
            return;
        ...
        0 == r
          ? ((i.additiveValue = u),
            (i.multiplyValue = g),
            (i.overwriteValue = d))
          : ((i.additiveValue = i.additiveValue * (1 - a) + u * a),
            (i.multiplyValue = i.multiplyValue * (1 - a) + g * a),
            (i.overwriteValue = i.overwriteValue * (1 - a) + d * a));
      }
    }
  }
  ...
  parse(t, e) {
    ...
    const r = s.getValueByString(Dt).getSize();
    this._parameters.prepareCapacity(r);
    for (let t = 0; t < r; ++t) {
      const e = s.getValueByString(Dt).getValueByIndex(t),
        i = $.getIdManager().getId(e.getValueByString("Id").getRawString()),
        r = e.getValueByString("Value").toFloat();
      let a;
      a =
        e.getValueByString(At).isNull() ||
        "Add" == e.getValueByString(At).getString()
          ? kt.Additive
          : "Multiply" == e.getValueByString(At).getString()
          ? kt.Multiply
          : "Overwrite" == e.getValueByString(At).getString()
          ? kt.Overwrite
          : kt.Additive;
      const n = new Ut();
      (n.parameterId = i),
  ...
  constructor() {
    super(), (this._parameters = new e()), (this._fadeWeight = 0);
  }
}
var kt, Nt, zt;
(Ot.DefaultAdditiveValue = 0),
  (Ot.DefaultMultiplyValue = 1),
  (function (t) {
...
class Ut {}
!(function (t) {
  (t.CubismExpressionMotion = Ot),
    (t.ExpressionBlendType = kt),
    (t.ExpressionParameter = Ut);
})(Nt || (Nt = {}));
class Gt {
  constructor() {
    (this._autoDelete = !1),
...
var jt, Ht, qt, Wt, Jt;
!(function (t) {
  (t.CubismMotionQueueManager = Xt),
    (t.InvalidMotionQueueEntryHandleValue = Yt);
})(jt || (jt = {}));
class $t {}
class Zt extends Xt {
  constructor() {
    super(),
      ...
      (this._expressionParameterValues = new e()),
      (this._fadeWeights = new e());
  }
  release() {
    this._expressionParameterValues &&
      (J(this._expressionParameterValues),
      (this._expressionParameterValues = null)),
      this._fadeWeights && (J(this._fadeWeights), (this._fadeWeights = null));
  }
  getCurrentPriority() {
    return (
      M(
  ...
  setFadeWeight(t, e) {
    t < 0 || this._fadeWeights.getSize() < 1 || this._fadeWeights.getSize() <= t
      ? console.warn(
  ...
  updateMotion(t, e) {
    ...
    if (this._fadeWeights.getSize() !== s.getSize()) {
      const t = s.getSize() - this._fadeWeights.getSize();
      for (let e = 0; e < t; e++) this._fadeWeights.pushBack(0);
    }
    for (let e = this._motions.begin(); e.notEqual(this._motions.end()); ) {
      ...
      const o = n.getCubismMotion();
      if (null == o) {
        J(n), (e = s.erase(e));
        continue;
      }
      const l = o.getExpressionParameters();
      if (n.isAvailable())
        for (let e = 0; e < l.getSize(); ++e) {
          if (null == l.at(e).parameterId) continue;
          let i = -1;
          for (let t = 0; t < this._expressionParameterValues.getSize(); ++t)
            if (
              this._expressionParameterValues.at(t).parameterId ==
              l.at(e).parameterId
            ) {
              i = t;
              break;
          ...
          if (i >= 0) continue;
          const s = new $t();
          (s.parameterId = l.at(e).parameterId),
            (s.additiveValue = Ot.DefaultAdditiveValue),
            (s.multiplyValue = Ot.DefaultMultiplyValue),
            (s.overwriteValue = t.getParameterValueById(s.parameterId)),
            this._expressionParameterValues.pushBack(s);
        }
      o.setupMotionQueueEntry(n, this._userTimeSeconds),
        this.setFadeWeight(a, o.updateFadeWeight(n, this._userTimeSeconds)),
        o.calculateExpressionParameters(
          t,
          this._userTimeSeconds,
          n,
          this._expressionParameterValues,
          a,
          this.getFadeWeight(a)
        ),
        (r +=
          0 == o.getFadeInTime()
            ? 1
            : Vt.getEasingSine(
                (this._userTimeSeconds - n.getFadeInStartTime()) /
                  o.getFadeInTime()
              )),
        (i = !0),
        n.isTriggeredFadeOut() &&
          n.startFadeOut(n.getFadeOutSeconds(), this._userTimeSeconds),
        e.preIncrement(),
        ++a;
    }
    if (s.getSize() > 1) {
      if (this.getFadeWeight(this._fadeWeights.getSize() - 1) >= 1)
        for (let t = s.getSize() - 2; t >= 0; --t) {
          J(s.at(t)), s.remove(t), this._fadeWeights.remove(t);
        }
    }
    r > 1 && (r = 1);
    for (let e = 0; e < this._expressionParameterValues.getSize(); ++e) {
      const i = this._expressionParameterValues.at(e);
      t.setParameterValueById(
        i.parameterId,
        (i.overwriteValue + i.additiveValue) * i.multiplyValue,
        r
      ),
        (i.additiveValue = Ot.DefaultAdditiveValue),
        (i.multiplyValue = Ot.DefaultMultiplyValue);
...
((Ht || (Ht = {})).CubismExpressionMotionManager = Zt),
  (function (t) {
...
class te {
  constructor() {
    (this.type = qt.CubismMotionCurveTarget_Model),
      (this.segmentCount = 0),
...
!(function (t) {
  (t.CubismMotionCurve = te),
    (t.CubismMotionCurveTarget = qt),
    (t.CubismMotionData = ie),
    (t.CubismMotionEvent = ee),
    (t.CubismMotionPoint = Kt),
    (t.CubismMotionSegment = Qt),
    (t.CubismMotionSegmentType = Wt);
})(Jt || (Jt = {}));
const se = "Meta",
  re = "Curves",
  ae = "FadeInTime",
...
class he {
  ...
  hasConsistency() {
    ...
    const e = this._json.getRoot().getValueByString(re).getVector().getSize();
    let i = 0,
      s = 0;
    for (let t = 0; t < e; ++t)
      for (let e = 0; e < this.getMotionCurveSegmentCount(t); ) {
        0 == e && ((s += 1), (e += 2));
        switch (this.getMotionCurveSegment(t, e)) {
    ...
    return (
      e != this.getMotionCurveCount() &&
        (v("The number of curves does not match the metadata."), (t = !1)),
      i != this.getMotionTotalSegmentCount() &&
        (v("The number of segment does not match the metadata."), (t = !1)),
      s != this.getMotionTotalPointCount() &&
        (v("The number of point does not match the metadata."), (t = !1)),
      t
    );
  }
  getEvaluationOptionFlag(t) {
    return (
      ue.EvaluationOptionFlag_AreBeziersRistricted == t &&
      this._json
        .getRoot()
        .getValueByString(se)
...
function Se(t, e, i, s, r) {
  const a = t.curves.at(e);
  let n = -1;
  const o = a.baseSegmentIndex + a.segmentCount;
  let l = 0;
  for (let e = a.baseSegmentIndex; e < o; ++e)
    if (
      ((l =
        t.segments.at(e).basePointIndex +
        (t.segments.at(e).segmentType == Wt.CubismMotionSegmentType_Bezier
          ? 3
          : 1)),
      t.points.at(l).time > i)
    ) {
      n = e;
      break;
    }
  if (-1 == n)
    return s && i < r
      ? (function (t, e, i, s, r, a) {
          const n = [new Kt(), new Kt()];
          {
            const e = t.points.at(s);
            (n[0].time = e.time), (n[0].value = e.value);
          }
          {
            const e = t.points.at(i);
            (n[1].time = a), (n[1].value = e.value);
          }
        ...
        })(t, o - 1, t.segments.at(a.baseSegmentIndex).basePointIndex, l, i, r)
      : t.points.at(l).value;
  const h = t.segments.at(n);
  return h.evaluate(t.points.get(h.basePointIndex), i);
}
var Ce, xe, Me, ve, be, Pe;
!(function (t) {
  (t[(t.MotionBehavior_V1 = 0)] = "MotionBehavior_V1"),
    (t[(t.MotionBehavior_V2 = 1)] = "MotionBehavior_V2");
})(Ce || (Ce = {}));
class Be extends Lt {
  static create(t, e, i, s, r = !1) {
    const a = new Be();
    return (
      a.parse(t, e, r),
      a._motionData
  ...
  doUpdateParameters(t, e, i, s) {
    null == this._modelCurveIdEyeBlink &&
      (this._modelCurveIdEyeBlink = $.getIdManager().getId("EyeBlink")),
      null == this._modelCurveIdLipSync &&
        (this._modelCurveIdLipSync = $.getIdManager().getId("LipSync")),
      null == this._modelCurveIdOpacity &&
        (this._modelCurveIdOpacity = $.getIdManager().getId(de)),
      this._motionBehavior === Ce.MotionBehavior_V2 &&
        this._previousLoopState !== this._isLoop &&
    ...
    const u =
        this._fadeInSeconds <= 0
          ? 1
          : Vt.getEasingSine(
              (e - s.getFadeInStartTime()) / this._fadeInSeconds
            ),
      g =
        this._fadeOutSeconds <= 0 || s.getEndTime() < 0
          ? 1
          : Vt.getEasingSine((s.getEndTime() - e) / this._fadeOutSeconds);
    let d,
      _,
      c,
      m = r,
      p = this._motionData.duration;
    const f = this._motionBehavior === Ce.MotionBehavior_V2 && this._isLoop;
    if (this._isLoop)
      for (
        this._motionBehavior === Ce.MotionBehavior_V2 &&
        (p += 1 / this._motionData.fps);
        m > p;
    ...
    for (
      ...
      y.at(_).type == qt.CubismMotionCurveTarget_Model;
      ++_
    )
      (d = Se(this._motionData, _, m, f, p)),
        y.at(_).id == this._modelCurveIdEyeBlink
          ? (n = d)
          : y.at(_).id == this._modelCurveIdLipSync
          ? (a = d)
          : y.at(_).id == this._modelCurveIdOpacity &&
            ((this._modelOpacity = d),
            t.setModelOapcity(this.getModelOpacityValue()));
    for (
      ;
      _ < this._motionData.curveCount &&
      y.at(_).type == qt.CubismMotionCurveTarget_Parameter;
      ++_
    ) {
      if (((c = t.getParameterIndex(y.at(_).id)), -1 == c)) continue;
      const r = t.getParameterValueByIndex(c);
      if (((d = Se(this._motionData, _, m, f, p)), n != Number.MAX_VALUE))
        for (let t = 0; t < this._eyeBlinkParameterIds.getSize() && t < o; ++t)
          if (this._eyeBlinkParameterIds.at(t) == y.at(_).id) {
            (d *= n), (h |= 1 << t);
            break;
          }
      if (a != Number.MAX_VALUE)
        for (let t = 0; t < this._lipSyncParameterIds.getSize() && t < o; ++t)
          if (this._lipSyncParameterIds.at(t) == y.at(_).id) {
            (d += a), (l |= 1 << t);
            break;
          }
      let S;
      if (
        (t.isRepeat(c) && (d = t.getParameterRepeatValue(c, d)),
        y.at(_).fadeInTime < 0 && y.at(_).fadeOutTime < 0)
      )
        S = r + (d - r) * i;
      else {
        let t, i;
        (t =
          y.at(_).fadeInTime < 0
            ...
            ? 1
            : Vt.getEasingSine(
                (e - s.getFadeInStartTime()) / y.at(_).fadeInTime
              )),
          (i =
            y.at(_).fadeOutTime < 0
              ? g
              : 0 == y.at(_).fadeOutTime || s.getEndTime() < 0
              ? 1
              : Vt.getEasingSine((s.getEndTime() - e) / y.at(_).fadeOutTime));
        S = r + (d - r) * (this._weight * t * i);
      }
    ...
    for (
      ;
      _ < this._motionData.curveCount &&
      y.at(_).type == qt.CubismMotionCurveTarget_PartOpacity;
      ++_
    )
      (c = t.getParameterIndex(y.at(_).id)),
        -1 != c &&
          ((d = Se(this._motionData, _, m, f, p)),
          t.setParameterValueByIndex(c, d));
    r >= p &&
      (this._isLoop
  ...
  setIsLoop(t) {
    v("setIsLoop() is a deprecated function. Please use setLoop()."),
      (this._isLoop = t);
  }
  isLoop() {
    return (
      v("isLoop() is a deprecated function. Please use getLoop()."),
      this._isLoop
    );
  }
  setIsLoopFadeIn(t) {
  ...
  isLoopFadeIn() {
    return (
      v("isLoopFadeIn() is a deprecated function. Please use getLoopFadeIn()."),
      this._isLoopFadeIn
    );
  }
  setMotionBehavior(t) {
    ...
    switch (this._motionBehavior) {
      ...
      default:
        t.setStartTime(e - i),
          ...
          null != this._onFinishedMotion && this._onFinishedMotion(this);
        break;
  ...
  parse(t, e, i = !1) {
    ...
    if (i) {
      if (!s.hasConsistency())
        return s.release(), void b("Inconsistent motion3.json.");
    }
    (this._motionData = new ie()),
    ...
    const r = s.getEvaluationOptionFlag(
      ue.EvaluationOptionFlag_AreBeziersRistricted
    );
    s.isExistMotionFadeInTime()
      ? (this._fadeInSeconds =
          s.getMotionFadeInTime() < 0 ? 1 : s.getMotionFadeInTime())
      : (this._fadeInSeconds = 1),
      s.isExistMotionFadeOutTime()
        ? (this._fadeOutSeconds =
            s.getMotionFadeOutTime() < 0 ? 1 : s.getMotionFadeOutTime())
        : (this._fadeOutSeconds = 1),
      this._motionData.curves.updateSize(this._motionData.curveCount, te, !0),
      this._motionData.segments.updateSize(
        s.getMotionTotalSegmentCount(),
        Qt,
        !0
      ),
      this._motionData.points.updateSize(s.getMotionTotalPointCount(), Kt, !0),
      this._motionData.events.updateSize(this._motionData.eventCount, ee, !0);
    let a = 0,
      n = 0;
    for (let t = 0; t < this._motionData.curveCount; ++t) {
      "Model" == s.getMotionCurveTarget(t)
        ? (this._motionData.curves.at(t).type =
            qt.CubismMotionCurveTarget_Model)
        : "Parameter" == s.getMotionCurveTarget(t)
        ? (this._motionData.curves.at(t).type =
            qt.CubismMotionCurveTarget_Parameter)
        : "PartOpacity" == s.getMotionCurveTarget(t)
        ? (this._motionData.curves.at(t).type =
            qt.CubismMotionCurveTarget_PartOpacity)
        : v(
            'Warning : Unable to get segment type from Curve! The number of "CurveCount" may be incorrect!'
          ),
        (this._motionData.curves.at(t).id = s.getMotionCurveId(t)),
        (this._motionData.curves.at(t).baseSegmentIndex = n),
        (this._motionData.curves.at(t).fadeInTime =
          s.isExistMotionCurveFadeInTime(t)
            ? s.getMotionCurveFadeInTime(t)
            : -1),
        (this._motionData.curves.at(t).fadeOutTime =
          s.isExistMotionCurveFadeOutTime(t)
            ? s.getMotionCurveFadeOutTime(t)
            : -1);
      for (let e = 0; e < s.getMotionCurveSegmentCount(t); ) {
        0 == e
          ? ((this._motionData.segments.at(n).basePointIndex = a),
            (this._motionData.points.at(a).time = s.getMotionCurveSegment(
              t,
              e
            )),
            (this._motionData.points.at(a).value = s.getMotionCurveSegment(
              t,
              e + 1
            )),
            (a += 1),
        ...
        switch (s.getMotionCurveSegment(t, e)) {
          case Wt.CubismMotionSegmentType_Linear:
            (this._motionData.segments.at(n).segmentType =
              Wt.CubismMotionSegmentType_Linear),
              (this._motionData.segments.at(n).evaluate = ce),
              (this._motionData.points.at(a).time = s.getMotionCurveSegment(
                t,
                e + 1
              )),
          ...
          case Wt.CubismMotionSegmentType_Bezier:
            (this._motionData.segments.at(n).segmentType =
              Wt.CubismMotionSegmentType_Bezier),
              (this._motionData.segments.at(n).evaluate = r ? me : pe),
              (this._motionData.points.at(a).time = s.getMotionCurveSegment(
                t,
                e + 1
              )),
              ...
              (this._motionData.points.at(a + 1).time = s.getMotionCurveSegment(
                t,
                e + 3
              )),
              (this._motionData.points.at(a + 1).value =
                s.getMotionCurveSegment(t, e + 4)),
              (this._motionData.points.at(a + 2).time = s.getMotionCurveSegment(
                t,
                e + 5
              )),
              (this._motionData.points.at(a + 2).value =
                s.getMotionCurveSegment(t, e + 6)),
              (a += 3),
              (e += 7);
            break;
          case Wt.CubismMotionSegmentType_Stepped:
            (this._motionData.segments.at(n).segmentType =
              Wt.CubismMotionSegmentType_Stepped),
              (this._motionData.segments.at(n).evaluate = fe),
              (this._motionData.points.at(a).time = s.getMotionCurveSegment(
                t,
                e + 1
              )),
          ...
          case Wt.CubismMotionSegmentType_InverseStepped:
            (this._motionData.segments.at(n).segmentType =
              Wt.CubismMotionSegmentType_InverseStepped),
              (this._motionData.segments.at(n).evaluate = ye),
              (this._motionData.points.at(a).time = s.getMotionCurveSegment(
                t,
                e + 1
              )),
        ...
        ++this._motionData.curves.at(t).segmentCount, ++n;
      }
    }
    for (let t = 0; t < s.getEventCount(); ++t)
      (this._motionData.events.at(t).fireTime = s.getEventTime(t)),
        (this._motionData.events.at(t).value = s.getEventValue(t));
    ...
    for (let i = 0; i < this._motionData.eventCount; ++i)
      this._motionData.events.at(i).fireTime > t &&
        ...
        this._firedEventValues.pushBack(
          new g(this._motionData.events.at(i).value.s)
        );
    return this._firedEventValues;
  }
  isExistModelOpacity() {
    for (let t = 0; t < this._motionData.curveCount; t++) {
      ...
      if (
        e.type == qt.CubismMotionCurveTarget_Model &&
        0 == e.id.getString().s.localeCompare(de)
      )
        return !0;
    }
    return !1;
  ...
  getModelOpacityId(t) {
    if (-1 != t) {
      ...
      if (
        ...
        return $.getIdManager().getId(e.id.getString().s);
    }
    return null;
  }
  getModelOpacityValue() {
...
class Ee {
  constructor() {
    (this.initialPosition = new It(0, 0)),
      (this.position = new It(0, 0)),
      (this.lastPosition = new It(0, 0)),
      (this.lastGravity = new It(0, 0)),
      (this.force = new It(0, 0)),
      (this.velocity = new It(0, 0));
  }
}
class Re {
  constructor() {
    (this.normalizationPosition = new Ve()),
      (this.normalizationAngle = new Ve());
  }
}
class Te {
  constructor() {
...
class De {
  constructor() {
    (this.settings = new e()),
      ...
      (this.gravity = new It(0, 0)),
      (this.wind = new It(0, 0)),
      (this.fps = 0);
  }
}
!(function (t) {
  (t.CubismPhysicsInput = Te),
    (t.CubismPhysicsNormalization = Ve),
    (t.CubismPhysicsOutput = Le),
    (t.CubismPhysicsParameter = Ie),
    (t.CubismPhysicsParticle = Ee),
    (t.CubismPhysicsRig = De),
    (t.CubismPhysicsSource = be),
    (t.CubismPhysicsSubRig = Re),
    (t.CubismPhysicsTargetType = ve),
    (t.PhysicsJsonEffectiveForces = Fe);
})(Pe || (Pe = {}));
const Ae = "Position",
  Oe = "Angle",
  ke = "Type",
...
class ii {
  ...
  parse(t, e) {
    ...
    (this._physicsRig.gravity = i.getGravity()),
      ...
      this._physicsRig.inputs.updateSize(i.getTotalInputCount(), Te, !0),
      this._physicsRig.outputs.updateSize(i.getTotalOutputCount(), Le, !0),
      this._physicsRig.particles.updateSize(i.getVertexCount(), Ee, !0),
    ...
    for (let t = 0; t < this._physicsRig.settings.getSize(); ++t) {
      ...
      for (let e = 0; e < this._physicsRig.settings.at(t).inputCount; ++e)
        (this._physicsRig.inputs.at(s + e).sourceParameterIndex = -1),
          ...
          "X" == i.getInputType(t, e)
            ? ((this._physicsRig.inputs.at(s + e).type =
                be.CubismPhysicsSource_X),
              (this._physicsRig.inputs.at(s + e).getNormalizedParameterValue =
                ai))
            ...
            ? ((this._physicsRig.inputs.at(s + e).type =
              ...
              (this._physicsRig.inputs.at(s + e).getNormalizedParameterValue =
                ni))
            : i.getInputType(t, e) == ei &&
              ((this._physicsRig.inputs.at(s + e).type =
                be.CubismPhysicsSource_Angle),
              (this._physicsRig.inputs.at(s + e).getNormalizedParameterValue =
                oi)),
          (this._physicsRig.inputs.at(s + e).source.targetType =
            ve.CubismPhysicsTargetType_Parameter),
          (this._physicsRig.inputs.at(s + e).source.id = i.getInputSourceId(
            t,
            e
          ));
      ...
      for (let s = 0; s < this._physicsRig.settings.at(t).outputCount; ++s)
        e.outputs.set(s, 0),
          ...
          (this._physicsRig.outputs.at(r + s).vertexIndex =
            i.getOutputVertexIndex(t, s)),
          (this._physicsRig.outputs.at(r + s).angleScale =
            i.getOutputAngleScale(t, s)),
          (this._physicsRig.outputs.at(r + s).weight = i.getOutputWeight(t, s)),
          (this._physicsRig.outputs.at(r + s).destination.targetType =
            ve.CubismPhysicsTargetType_Parameter),
          (this._physicsRig.outputs.at(r + s).destination.id =
            i.getOutputDestinationId(t, s)),
          "X" == i.getOutputType(t, s)
            ? ((this._physicsRig.outputs.at(r + s).type =
                be.CubismPhysicsSource_X),
              (this._physicsRig.outputs.at(r + s).getValue = li),
              (this._physicsRig.outputs.at(r + s).getScale = di))
            : "Y" == i.getOutputType(t, s)
            ? ((this._physicsRig.outputs.at(r + s).type =
                be.CubismPhysicsSource_Y),
              (this._physicsRig.outputs.at(r + s).getValue = hi),
              (this._physicsRig.outputs.at(r + s).getScale = _i))
            : i.getOutputType(t, s) == ei &&
              ((this._physicsRig.outputs.at(r + s).type =
                be.CubismPhysicsSource_Angle),
              (this._physicsRig.outputs.at(r + s).getValue = ui),
              (this._physicsRig.outputs.at(r + s).getScale = ci)),
          (this._physicsRig.outputs.at(r + s).reflect = i.getOutputReflect(
            t,
            s
          ));
      ...
      for (let e = 0; e < this._physicsRig.settings.at(t).particleCount; ++e)
        (this._physicsRig.particles.at(a + e).mobility = i.getParticleMobility(
          t,
          e
        )),
          (this._physicsRig.particles.at(a + e).delay = i.getParticleDelay(
            t,
            e
          )),
          (this._physicsRig.particles.at(a + e).acceleration =
            i.getParticleAcceleration(t, e)),
          (this._physicsRig.particles.at(a + e).radius = i.getParticleRadius(
            t,
            e
          )),
          (this._physicsRig.particles.at(a + e).position =
            i.getParticlePosition(t, e));
  ...
  stabilization(t) {
    ...
    (null !==
      (i =
        null === (e = this._parameterCaches) || void 0 === e
          ? void 0
          : e.length) && void 0 !== i
      ? i
      ...
      (null !==
        (r =
          null === (s = this._parameterInputCaches) || void 0 === s
            ? void 0
            : s.length) && void 0 !== r
        ? r
        : 0) < t.getParameterCount() &&
    ...
    for (let e = 0; e < t.getParameterCount(); ++e)
      (this._parameterCaches[e] = c[e]), (this._parameterInputCaches[e] = c[e]);
    for (let e = 0; e < this._physicsRig.subRigCount; ++e) {
      (a = { angle: 0 }),
        (h.x = 0),
        (h.y = 0),
        (u = this._physicsRig.settings.at(e)),
        (g = this._physicsRig.inputs.get(u.baseInputIndex)),
        (d = this._physicsRig.outputs.get(u.baseOutputIndex)),
        (_ = this._physicsRig.particles.get(u.baseParticleIndex));
      for (let e = 0; e < u.inputCount; ++e)
        (n = g[e].weight / 100),
          ...
          (this._parameterCaches[g[e].sourceParameterIndex] =
            c[g[e].sourceParameterIndex]);
      (o = Vt.degreesToRadian(-a.angle)),
        (h.x = h.x * Vt.cos(o) - h.y * Vt.sin(o)),
        (h.y = h.x * Vt.sin(o) + h.y * Vt.cos(o)),
        pi(
          _,
          u.particleCount,
          h,
      ...
      for (let i = 0; i < u.outputCount; ++i) {
        const s = d[i].vertexIndex;
        if (
          (-1 == d[i].destinationParameterIndex &&
            (d[i].destinationParameterIndex = t.getParameterIndex(
              d[i].destination.id
            )),
          s < 1 || s >= u.particleCount)
        )
          continue;
        let r = new It();
        (r = _[s].position.substract(_[s - 1].position)),
          (l = d[i].getValue(r, _, s, d[i].reflect, this._options.gravity)),
        ...
        for (let t = a, e = 0; t < this._parameterCaches.length; t++, e++)
          c[t] = this._parameterCaches[t] = n[e];
      }
    }
  }
  evaluate(t, e) {
    ...
    let g, d, _, c;
    if (0 >= e) return;
    const m = t.getModel().parameters.values,
    ...
    if (
      ...
      (null !==
        (s =
          null === (i = this._parameterCaches) || void 0 === i
            ? void 0
            : i.length) && void 0 !== s
        ? s
        : 0) < t.getParameterCount() &&
      ...
      (null !==
        (a =
          null === (r = this._parameterInputCaches) || void 0 === r
            ? void 0
            : r.length) && void 0 !== a
        ? a
        : 0) < t.getParameterCount())
      ...
      this._parameterInputCaches = new Float32Array(t.getParameterCount());
      for (let e = 0; e < t.getParameterCount(); ++e)
        this._parameterInputCaches[e] = m[e];
    }
    for (
      ...
      for (let t = 0; t < this._physicsRig.subRigCount; ++t) {
        (g = this._physicsRig.settings.at(t)),
          (_ = this._physicsRig.outputs.get(g.baseOutputIndex));
      ...
      for (let i = 0; i < t.getParameterCount(); ++i)
        (this._parameterCaches[i] =
          this._parameterInputCaches[i] * (1 - e) + m[i] * e),
      ...
      for (let e = 0; e < this._physicsRig.subRigCount; ++e) {
        (n = { angle: 0 }),
          ...
          (_ = this._physicsRig.outputs.get(g.baseOutputIndex)),
          (c = this._physicsRig.particles.get(g.baseParticleIndex));
        ...
        (l = Vt.degreesToRadian(-n.angle)),
          (u.x = u.x * Vt.cos(l) - u.y * Vt.sin(l)),
          (u.y = u.x * Vt.sin(l) + u.y * Vt.cos(l)),
          mi(
            c,
            g.particleCount,
            u,
        ...
        for (let i = 0; i < g.outputCount; ++i) {
          const s = _[i].vertexIndex;
          if (
            (-1 == _[i].destinationParameterIndex &&
              (_[i].destinationParameterIndex = t.getParameterIndex(
                _[i].destination.id
              )),
            ...
            continue;
          const r = new It();
          (r.x = c[s].position.x - c[s - 1].position.x),
            (r.y = c[s].position.y - c[s - 1].position.y),
            (h = _[i].getValue(r, c, s, _[i].reflect, this._options.gravity)),
            this._currentRigOutputs.at(e).outputs.set(i, h);
          const a = _[i].destinationParameterIndex,
            n =
              !Float32Array.prototype.slice &&
              "subarray" in Float32Array.prototype
    ...
    const C = this._currentRemainTime / S;
    this.interpolate(t, C);
  }
  interpolate(t, e) {
    let i, s;
    const r = t.getModel().parameters.values,
  ...
  constructor() {
    (this._physicsRig = null),
      (this._options = new si()),
      (this._options.gravity.y = -1),
      (this._options.gravity.x = 0),
      (this._options.wind.x = 0),
      (this._options.wind.y = 0),
      (this._currentRigOutputs = new e()),
      (this._previousRigOutputs = new e()),
  ...
  initialize() {
    ...
    for (let s = 0; s < this._physicsRig.subRigCount; ++s) {
      (e = this._physicsRig.settings.at(s)),
        ...
        (t[0].initialPosition = new It(0, 0)),
        (t[0].lastPosition = new It(
          t[0].initialPosition.x,
          t[0].initialPosition.y
        )),
        (t[0].lastGravity = new It(0, -1)),
        (t[0].lastGravity.y *= -1),
        (t[0].velocity = new It(0, 0)),
        (t[0].force = new It(0, 0));
      for (let s = 1; s < e.particleCount; ++s)
        (i = new It(0, 0)),
          (i.y = t[s].radius),
          (t[s].initialPosition = new It(
          ...
          (t[s].lastPosition = new It(
            t[s].initialPosition.x,
            t[s].initialPosition.y
          )),
          (t[s].lastGravity = new It(0, -1)),
          (t[s].lastGravity.y *= -1),
          (t[s].velocity = new It(0, 0)),
          (t[s].force = new It(0, 0));
    }
  }
}
class si {
...
function mi(t, e, i, s, r, a, n, o) {
  ...
  const c = Vt.degreesToRadian(s),
    m = Vt.radianToDirection(c);
  m.normalize();
  for (let i = 1; i < e; ++i)
    (t[i].force = m.multiplyByScaler(t[i].acceleration).add(r)),
      (t[i].lastPosition = new It(t[i].position.x, t[i].position.y)),
      (l = t[i].delay * n * 30),
      (u = t[i].position.substract(t[i - 1].position)),
      (h = Vt.directionToRadian(t[i].lastGravity, m) / o),
      (u.x = Vt.cos(h) * u.x - u.y * Vt.sin(h)),
      (u.y = Vt.sin(h) * u.x + u.y * Vt.cos(h)),
      (t[i].position = t[i - 1].position.add(u)),
      (g = t[i].velocity.multiplyByScaler(l)),
      (d = t[i].force.multiplyByScaler(l).multiplyByScaler(l)),
      (t[i].position = t[i].position.add(g).add(d)),
      (_ = t[i].position.substract(t[i - 1].position)),
      _.normalize(),
      (t[i].position = t[i - 1].position.add(_.multiplyByScaler(t[i].radius))),
      Vt.abs(t[i].position.x) < a && (t[i].position.x = 0),
      0 != l &&
        ((t[i].velocity = t[i].position.substract(t[i].lastPosition)),
        (t[i].velocity = t[i].velocity.divisionByScalar(l)),
        (t[i].velocity = t[i].velocity.multiplyByScaler(t[i].mobility))),
      (t[i].force = new It(0, 0)),
      (t[i].lastGravity = new It(m.x, m.y));
}
function pi(t, e, i, s, r, a) {
  let n = new It(0, 0);
  t[0].position = new It(i.x, i.y);
  const o = Vt.degreesToRadian(s),
    l = Vt.radianToDirection(o);
  l.normalize();
  for (let i = 1; i < e; ++i)
    (t[i].force = l.multiplyByScaler(t[i].acceleration).add(r)),
      (t[i].lastPosition = new It(t[i].position.x, t[i].position.y)),
      (t[i].velocity = new It(0, 0)),
      (n = t[i].force),
      n.normalize(),
      (n = n.multiplyByScaler(t[i].radius)),
      (t[i].position = t[i - 1].position.add(n)),
      Vt.abs(t[i].position.x) < a && (t[i].position.x = 0),
      (t[i].force = new It(0, 0)),
      (t[i].lastGravity = new It(l.x, l.y));
}
function fi(t, e, i, s, r) {
  let a;
  (a = s * r.getScale(r.translationScale, r.angleScale)),
    a < e
      ? (a < r.valueBelowMinimum && (r.valueBelowMinimum = a), (a = e))
      : a > i &&
        (a > r.valueExceededMaximum && (r.valueExceededMaximum = a), (a = i));
  const n = r.weight / 100;
...
class Ci {
  constructor(t) {
    (this._renderTextureCount = 0),
      ...
      (this._clippingContextListForMask = new e()),
      (this._clippingContextListForDraw = new e()),
      (this._channelColors = new e()),
      (this._tmpBoundsOnModel = new m()),
      (this._tmpMatrix = new c()),
      (this._tmpMatrixForMask = new c()),
      (this._tmpMatrixForDraw = new c()),
    ...
    (i.r = 1),
      ...
      (i.b = 0),
      (i.a = 0),
      this._channelColors.pushBack(i),
      (i = new f()),
      (i.r = 0),
      (i.g = 1),
      (i.b = 0),
  ...
  release() {
    ...
    (this._channelColors = null),
      null != this._clearedFrameBufferFlags &&
  ...
  initialize(t, i) {
    i % 1 != 0 &&
      ...
      (this._renderTextureCount = i < 1 ? 1 : i),
      (this._clearedFrameBufferFlags = new e(this._renderTextureCount));
    for (let e = 0; e < t.getDrawableCount(); e++) {
      if (t.getDrawableMaskCounts()[e] <= 0) {
        this._clippingContextListForDraw.pushBack(null);
        continue;
      }
      let i = this.findSameClip(
        t.getDrawableMasks()[e],
        t.getDrawableMaskCounts()[e]
      );
      null == i &&
  ...
  setupMatrixForHighPrecision(t, e) {
    ...
    if (i > 0) {
      ...
      for (let i = 0; i < this._clippingContextListForMask.getSize(); i++) {
        ...
        let o = 0,
          l = 0;
        const h = t.getPixelsPerUnit(),
          u = s.getClippingManager().getClippingMaskBufferSize(),
          g = a.width * u,
          d = a.height * u;
        this._tmpBoundsOnModel.setRect(r),
          this._tmpBoundsOnModel.width * h > g
            ? (this._tmpBoundsOnModel.expand(r.width * n, 0),
              (o = a.width / this._tmpBoundsOnModel.width))
            : (o = h / g),
          this._tmpBoundsOnModel.height * h > d
            ? (this._tmpBoundsOnModel.expand(0, r.height * n),
              (l = a.height / this._tmpBoundsOnModel.height))
            : (l = h / d),
          this.createMatrixForMask(e, a, o, l),
  ...
  setupLayoutBounds(t) {
    const e =
      this._renderTextureCount <= 1 ? 36 : 32 * this._renderTextureCount;
    if (t <= 0 || t > e) {
      t > e &&
        b(
    ...
    const r = t % this._renderTextureCount;
    s = Math.ceil(s);
    let a = s / 4;
    const n = s % 4;
    a = ~~a;
    ...
    for (let s = 0; s < this._renderTextureCount; s++)
      for (let l = 0; l < 4; l++) {
        let h = a + (l < n ? 1 : 0);
        if (
          (l == n + (a < 1 ? -1 : 0) && r > 0 && (h -= s < r ? 0 : 1), 0 == h)
        );
        else if (1 == h) {
          const t = this._clippingContextListForMask.at(o++);
          (t._layoutChannelIndex = l),
            (t._layoutBounds.x = 0),
            (t._layoutBounds.y = 0),
  ...
  calcClippedDrawTotalBounds(t, e) {
    ...
    for (let o = 0; o < n; o++) {
      ...
      let u = Number.MAX_VALUE,
        ...
        d = -Number.MAX_VALUE,
        _ = -Number.MAX_VALUE;
      const c = l * W.vertexStep;
      for (let t = W.vertexOffset; t < c; t += W.vertexStep) {
        const e = h[t],
          i = h[t + 1];
        e < u && (u = e), e > d && (d = e), i < g && (g = i), i > _ && (_ = i);
      }
...
class Mi {
  ...
  setupShaderProgramForDraw(t, e, i) {
    let s, r, a, n;
    t.isPremultipliedAlpha() || b("NoPremultipliedAlpha is not allowed"),
      0 == this._shaderSets.getSize() && this.generateShaders();
    const o = null != t.getClippingContextBufferForDraw(),
    ...
    switch (e.getDrawableBlendMode(i)) {
      ...
      default:
        (g = this._shaderSets.at(Pi.ShaderNames_NormalPremultipliedAlpha + u)),
          (s = this.gl.ONE),
          (r = this.gl.ONE_MINUS_SRC_ALPHA),
          (a = this.gl.ONE),
          (n = this.gl.ONE_MINUS_SRC_ALPHA);
        break;
      case h.CubismBlendMode_Additive:
        (g = this._shaderSets.at(Pi.ShaderNames_AddPremultipliedAlpha + u)),
          (s = this.gl.ONE),
          (r = this.gl.ONE),
          (a = this.gl.ZERO),
          (n = this.gl.ONE);
      ...
      case h.CubismBlendMode_Multiplicative:
        (g = this._shaderSets.at(Pi.ShaderNames_MultPremultipliedAlpha + u)),
          (s = this.gl.DST_COLOR),
          (r = this.gl.ONE_MINUS_SRC_ALPHA),
          (a = this.gl.ZERO),
          (n = this.gl.ONE);
    }
    this.gl.useProgram(g.shaderProgram),
      null == t._bufferData.vertex &&
        (t._bufferData.vertex = this.gl.createBuffer()),
      this.gl.bindBuffer(this.gl.ARRAY_BUFFER, t._bufferData.vertex);
    const d = e.getDrawableVertices(i);
    this.gl.bufferData(this.gl.ARRAY_BUFFER, d, this.gl.DYNAMIC_DRAW),
      this.gl.enableVertexAttribArray(g.attributePositionLocation),
      this.gl.vertexAttribPointer(
        g.attributePositionLocation,
        2,
        this.gl.FLOAT,
        !1,
        0,
      ...
      null == t._bufferData.uv && (t._bufferData.uv = this.gl.createBuffer()),
      this.gl.bindBuffer(this.gl.ARRAY_BUFFER, t._bufferData.uv);
    const _ = e.getDrawableVertexUvs(i);
    if (
      (this.gl.bufferData(this.gl.ARRAY_BUFFER, _, this.gl.DYNAMIC_DRAW),
      this.gl.enableVertexAttribArray(g.attributeTexCoordLocation),
      this.gl.vertexAttribPointer(
        g.attributeTexCoordLocation,
        2,
        this.gl.FLOAT,
        !1,
        0,
      ...
      this.gl.bindTexture(this.gl.TEXTURE_2D, e),
        this.gl.uniform1i(g.samplerTexture1Location, 1),
        this.gl.uniformMatrix4fv(
          g.uniformClipMatrixLocation,
          !1,
          t.getClippingContextBufferForDraw()._matrixForDraw.getArray()
        );
      const i = t.getClippingContextBufferForDraw()._layoutChannelIndex,
        s = t
          .getClippingContextBufferForDraw()
          .getClippingManager()
          .getChannelFlagAsColor(i);
      this.gl.uniform4f(g.uniformChannelFlagLocation, s.r, s.g, s.b, s.a);
    }
    const c = e.getDrawableTextureIndex(i),
      m = t.getBindedTextures().getValue(c);
    this.gl.activeTexture(this.gl.TEXTURE0),
      this.gl.bindTexture(this.gl.TEXTURE_2D, m),
      this.gl.uniform1i(g.samplerTexture0Location, 0);
    const p = t.getMvpMatrix();
    this.gl.uniformMatrix4fv(g.uniformMatrixLocation, !1, p.getArray());
    const f = t.getModelColorWithOpacity(e.getDrawableOpacity(i)),
      y = e.getMultiplyColor(i),
      S = e.getScreenColor(i);
    this.gl.uniform4f(g.uniformBaseColorLocation, f.r, f.g, f.b, f.a),
      this.gl.uniform4f(g.uniformMultiplyColorLocation, y.r, y.g, y.b, y.a),
      this.gl.uniform4f(g.uniformScreenColorLocation, S.r, S.g, S.b, S.a),
      null == t._bufferData.index &&
    ...
    this.gl.bindBuffer(this.gl.ELEMENT_ARRAY_BUFFER, t._bufferData.index),
      ...
      this.gl.blendFuncSeparate(s, r, a, n);
  }
  setupShaderProgramForMask(t, e, i) {
    t.isPremultipliedAlpha() || b("NoPremultipliedAlpha is not allowed"),
      0 == this._shaderSets.getSize() && this.generateShaders();
    const s = this._shaderSets.at(Pi.ShaderNames_SetupMask);
    this.gl.useProgram(s.shaderProgram),
      null == t._bufferData.vertex &&
        (t._bufferData.vertex = this.gl.createBuffer()),
      this.gl.bindBuffer(this.gl.ARRAY_BUFFER, t._bufferData.vertex);
    const r = e.getDrawableVertices(i);
    this.gl.bufferData(this.gl.ARRAY_BUFFER, r, this.gl.DYNAMIC_DRAW),
      ...
      null == t._bufferData.uv && (t._bufferData.uv = this.gl.createBuffer()),
      this.gl.bindBuffer(this.gl.ARRAY_BUFFER, t._bufferData.uv);
    const a = e.getDrawableTextureIndex(i),
    ...
    const l = t.getClippingContextBufferForMask()._layoutChannelIndex,
      h = t
    ...
    const u = t.getClippingContextBufferForMask()._layoutBounds;
    this.gl.uniform4f(
    ...
    const g = e.getMultiplyColor(i),
      d = e.getScreenColor(i);
    this.gl.uniform4f(s.uniformMultiplyColorLocation, g.r, g.g, g.b, g.a),
      this.gl.uniform4f(s.uniformScreenColorLocation, d.r, d.g, d.b, d.a);
    const _ = this.gl.ZERO,
      c = this.gl.ONE_MINUS_SRC_COLOR,
      m = this.gl.ZERO,
      p = this.gl.ONE_MINUS_SRC_ALPHA;
    null == t._bufferData.index &&
      (t._bufferData.index = this.gl.createBuffer());
    const f = e.getDrawableVertexIndices(i);
    this.gl.bindBuffer(this.gl.ELEMENT_ARRAY_BUFFER, t._bufferData.index),
      this.gl.bufferData(this.gl.ELEMENT_ARRAY_BUFFER, f, this.gl.DYNAMIC_DRAW),
      this.gl.blendFuncSeparate(_, c, m, p);
  }
  ...
  generateShaders() {
    for (let t = 0; t < 10; t++) this._shaderSets.pushBack(new bi());
    (this._shaderSets.at(0).shaderProgram = this.loadShaderProgram(Bi, wi)),
      (this._shaderSets.at(1).shaderProgram = this.loadShaderProgram(Fi, Vi)),
      (this._shaderSets.at(2).shaderProgram = this.loadShaderProgram(Ii, Ei)),
      (this._shaderSets.at(3).shaderProgram = this.loadShaderProgram(Ii, Ri)),
...
let Li, Di;
!(function (t) {
  (t.CubismShaderSet = bi),
    (t.CubismShader_WebGL = Mi),
    (t.CubismShaderManager_WebGL = vi),
    (t.ShaderNames = Pi);
})(Ti || (Ti = {}));
class Ai extends Ci {
  getMaskRenderTexture() {
    if (this._maskTexture && null != this._maskTexture.textures)
      ...
      null != this._maskRenderTextures && this._maskRenderTextures.clear(),
        (this._maskRenderTextures = new e()),
        null != this._maskColorBuffers && this._maskColorBuffers.clear(),
        (this._maskColorBuffers = new e());
      ...
      this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, Di),
        (this._maskTexture = new Oi(
  ...
  setupClippingContext(t, i) {
    this._currentFrameNo++;
    let s = 0;
    for (let e = 0; e < this._clippingContextListForMask.getSize(); e++) {
      const i = this._clippingContextListForMask.at(e);
      this.calcClippedDrawTotalBounds(t, i), i._isUsing && s++;
    }
    if (s > 0) {
      this.gl.viewport(
        0,
      ...
      for (let e = 0; e < this._clippingContextListForMask.getSize(); e++) {
        ...
        this._currentMaskRenderTexture != h &&
          ...
          this._tmpMatrix.scaleRelative(o, l),
          this._tmpMatrix.translateRelative(
            -this._tmpBoundsOnModel.x,
            -this._tmpBoundsOnModel.y
          ),
          ...
          s._matrixForMask.setMatrix(this._tmpMatrixForMask.getArray()),
          s._matrixForDraw.setMatrix(this._tmpMatrixForDraw.getArray());
        const u = s._clippingIdCount;
        for (let e = 0; e < u; e++) {
          const r = s._clippingIdList[e];
          t.getDrawableDynamicFlagVertexPositionsDidChange(r) &&
            (i.setIsCulling(0 != t.getDrawableCulling(r)),
            this._clearedFrameBufferFlags.at(s._bufferIndex) ||
              (this.gl.clearColor(1, 1, 1, 1),
              this.gl.clear(this.gl.COLOR_BUFFER_BIT),
              this._clearedFrameBufferFlags.set(s._bufferIndex, !0)),
            i.setClippingContextBufferForMask(s),
            i.drawMeshWebGL(t, r));
        }
      }
      this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, Di),
        i.setClippingContextBufferForMask(null),
        this.gl.viewport(Li[0], Li[1], Li[2], Li[3]);
    }
  }
  getColorBuffer() {
...
class zi extends p {
  ...
  constructor() {
    super(),
      ...
      (this._rendererProfile = new Ni()),
      (this.firstDraw = !0),
      (this._textures = new I()),
      (this._sortedDrawableIndexList = new e()),
      (this._bufferData = {
          ...
          this.gl.clear(this.gl.COLOR_BUFFER_BIT));
        {
          ...
          for (let e = 0; e < t; e++) {
            ...
            this._model.getDrawableDynamicFlagVertexPositionsDidChange(t) &&
              ...
              this.drawMeshWebGL(this._model, t));
          }
        }
        this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, Di),
...
(p.staticRelease = () => {
  ...
  (function (t) {
    (t.CubismClippingContext = ki),
      (t.CubismClippingManager_WebGL = Ai),
      (t.CubismRenderTextureResource = Oi),
      (t.CubismRenderer_WebGL = zi);
  })(Ui || (Ui = {}));
class Yi {
  constructor(t = !1, e = !1) {
...
class Wi {
  ...
  getMultiplyColor(t) {
    if (
      ...
      return this._userMultiplyColors.at(t).color;
  ...
  getScreenColor(t) {
    if (
      ...
      return this._userScreenColors.at(t).color;
  ...
  setPartOpacityByIndex(t, e) {
    this._notExistPartOpacities.isExist(t)
      ...
      : (C(0 <= t && t < this.getPartCount()), (this._partOpacities[t] = e));
  }
  ...
  getPartOpacityByIndex(t) {
    return this._notExistPartOpacities.isExist(t)
      ...
      : (C(0 <= t && t < this.getPartCount()), this._partOpacities[t]);
  }
  ...
  getParameterValueByIndex(t) {
    return this._notExistParameterValues.isExist(t)
      ...
      : (C(0 <= t && t < this.getParameterCount()), this._parameterValues[t]);
  }
  ...
  setParameterValueByIndex(t, e, i = 1) {
    this._notExistParameterValues.isExist(t)
      ...
      : (C(0 <= t && t < this.getParameterCount()),
        (e = this.isRepeat(t)
          ? this.getParameterRepeatValue(t, e)
          : this.getParameterClampValue(t, e)),
  ...
  isRepeat(t) {
    ...
    return (
      ...
      (e =
        ...
        this._userParameterRepeatDataList.at(t).isOverridden
          ? this._userParameterRepeatDataList.at(t).isParameterRepeated
          : 0 != this._model.parameters.repeats[t]),
      e
    );
  }
  getParameterRepeatValue(t, e) {
    ...
    const i = this._model.parameters.maximumValues[t],
      ...
      r = i - s;
    if (i < e) {
      const t = Vt.mod(e - i, r);
      e = Number.isNaN(t) ? i : s + t;
    }
    if (e < s) {
      const t = Vt.mod(s - e, r);
      e = Number.isNaN(t) ? s : i - t;
    }
    return e;
  }
  ...
  getDrawableBlendMode(t) {
    ...
    return Live2DCubismCore.Utils.hasBlendAdditiveBit(e[t])
      ? h.CubismBlendMode_Additive
      : Live2DCubismCore.Utils.hasBlendMultiplicativeBit(e[t])
      ? h.CubismBlendMode_Multiplicative
      : h.CubismBlendMode_Normal;
  }
  ...
  loadParameters() {
    ...
    t > e && (t = e);
    for (let e = 0; e < t; ++e)
      this._parameterValues[e] = this._savedParameters.at(e);
  }
  initialize() {
    C(this._model),
      ...
      (this._parameterMinimumValues = this._model.parameters.minimumValues);
    {
      ...
      this._parameterIds.prepareCapacity(e),
        this._userParameterRepeatDataList.prepareCapacity(e);
      for (let i = 0; i < e; ++i)
        this._parameterIds.pushBack($.getIdManager().getId(t[i])),
          this._userParameterRepeatDataList.pushBack(new Yi(!1, !1));
    }
    const t = this._model.parts.count;
    {
      ...
      for (let i = 0; i < t; ++i)
        this._partIds.pushBack($.getIdManager().getId(e[i]));
    ...
    {
      const i = this._model.drawables.ids,
        s = this._model.drawables.count;
      this._userMultiplyColors.prepareCapacity(s),
        this._userScreenColors.prepareCapacity(s),
        this._userCullings.prepareCapacity(s);
      const r = new qi(!1, !1);
      for (let i = 0; i < t; ++i) {
        const t = new f(1, 1, 1, 1),
          r = new f(0, 0, 0, 1),
          a = new Hi(!1, t),
          n = new Hi(!1, r);
        this._userPartMultiplyColors.pushBack(a),
          this._userPartScreenColors.pushBack(n),
          this._partChildDrawables.pushBack(new e()),
          this._partChildDrawables.at(i).prepareCapacity(s);
      }
      for (let t = 0; t < s; ++t) {
        const e = new f(1, 1, 1, 1),
          s = new f(0, 0, 0, 1),
          a = new ji(!1, e),
          n = new ji(!1, s);
        this._drawableIds.pushBack($.getIdManager().getId(i[t])),
  ...
  constructor(t) {
    (this._model = t),
      ...
      (this._savedParameters = new e()),
      (this._parameterIds = new e()),
      (this._drawableIds = new e()),
      (this._partIds = new e()),
      ...
      (this._modelOpacity = 1),
      (this._userParameterRepeatDataList = new e()),
      (this._userMultiplyColors = new e()),
      (this._userScreenColors = new e()),
      (this._userCullings = new e()),
      (this._userPartMultiplyColors = new e()),
      (this._userPartScreenColors = new e()),
      (this._partChildDrawables = new e()),
...
class es {
  ...
  parseUserData(t, e) {
    ...
    const s = $.getIdManager().getId("ArtMesh"),
      r = i.getUserDataCount();
    for (let t = 0; t < r; t++) {
      const e = new ts();
      (e.targetId = i.getUserDataId(t)),
        (e.targetType = $.getIdManager().getId(i.getUserDataTargetType(t))),
...
class rs {
  ...
  loadModel(t, e = !1) {
    (this._moc = Ji.create(t, e)),
      null != this._moc
        ? ((this._model = this._moc.createModel()),
          null != this._model
            ? (this._model.saveParameters(),
              (this._modelMatrix = new Ft(
  ...
  loadMotion(t, e, i, s, r, a, n, o, l = !1) {
    if (null == t || 0 == e) return b("Failed to loadMotion()."), null;
    const h = Be.create(t, e, s, r, l);
    if (null == h)
      return b("Failed to create motion from buffer in LoadMotion()"), null;
    if (a) {
      const t = a.getMotionFadeInTimeValue(n, o);
      t >= 0 && h.setFadeInTime(t);
      const e = a.getMotionFadeOutTimeValue(n, o);
      e >= 0 && h.setFadeOutTime(e);
    }
    return h;
  }
  ...
  loadPose(t, e) {
    null != t && 0 != e
      ? (this._pose = Mt.create(t, e))
      : b("Failed to loadPose().");
  }
  loadUserData(t, e) {
    null != t && 0 != e
      ? (this._modelUserData = es.create(t, e))
      : b("Failed to loadUserData().");
  }
  loadPhysics(t, e) {
    null != t && 0 != e
      ? (this._physics = ii.create(t, e))
  ...
  isHit(t, e, i) {
    ...
    let n = a[0],
      ...
      h = a[1];
    for (let t = 1; t < r; ++t) {
      const e = a[W.vertexOffset + t * W.vertexStep],
        i = a[W.vertexOffset + t * W.vertexStep + 1];
      e < n && (n = e), e > o && (o = e), i < l && (l = i), i > h && (h = i);
    }
    const u = this._modelMatrix.invertTransformX(e),
  ...
  constructor() {
    (this._moc = null),
      ...
      (this._debugMode = !1),
      (this._renderer = null),
      (this._motionManager = new we()),
      this._motionManager.setEventCallback(
        rs.cubismDefaultMotionEventCallback,
        this
      ),
      (this._expressionManager = new Zt()),
      (this._dragManager = new Et());
  }
  release() {
    null != this._motionManager &&
      ...
      null != this._moc &&
        ...
        (this._moc = null)),
      (this._modelMatrix = null),
      Mt.delete(this._pose),
      St.delete(this._eyeBlink),
      ft.delete(this._breath),
      (this._dragManager = null),
      ii.delete(this._physics),
      es.delete(this._modelUserData),
      this.deleteRenderer();
  }
}
...
class ns {
  ...
  loadWavFile(t) {
    return new Promise((e) => {
      ...
      (async () => {
        if (
          ((this._byteReader._fileByte = await (async () =>
            fetch(t).then((t) => t.arrayBuffer()))()),
          ...
          try {
            ...
            for (let t = 0; t < this._wavFileInfo._numberOfChannels; t++)
              this._pcmData[t] = new Float32Array(
                this._wavFileInfo._samplesPerChannel
              );
  ...
  constructor() {
    (this.loadFiletoBytes = (t, e) => {
      ...
      (this._lastRms = 0),
      (this._sampleOffset = 0),
      (this._wavFileInfo = new os()),
      (this._byteReader = new ls());
  }
}
class os {
  constructor() {
...
class gs extends rs {
  loadAssets(t, e) {
    (this._modelHomeDir = t),
      fetch(`${this._modelHomeDir}${e}`)
        .then((t) => t.arrayBuffer())
        .then((t) => {
          const e = new pt(t, t.byteLength);
          (this._state = hs.LoadModel), this.setupModel(e);
        })
        .catch((t) => {
          b(`Failed to load file ${this._modelHomeDir}${e}`);
        });
  }
  setupModel(t) {
    if (
      ...
      fetch(`${this._modelHomeDir}${t}`)
        ...
        .then((t) => {
          this.loadModel(t, this._mocConsistency),
            (this._state = hs.LoadExpression),
            i();
        }),
        (this._state = hs.WaitLoadModel);
    } else at.printMessage("Model data does not exist.");
    const i = () => {
        if (this._modelSetting.getExpressionCount() > 0) {
          const t = this._modelSetting.getExpressionCount();
          for (let e = 0; e < t; e++) {
            const i = this._modelSetting.getExpressionName(e),
              r = this._modelSetting.getExpressionFileName(e);
            fetch(`${this._modelHomeDir}${r}`)
              .then((t) =>
                t.ok
                  ? t.arrayBuffer()
                  : t.status >= 400
                  ? (b(`Failed to load file ${this._modelHomeDir}${r}`),
                    new ArrayBuffer(0))
                  : void 0
              )
              .then((e) => {
                const r = this.loadExpression(e, e.byteLength, i);
                null != this._expressions.getValue(i) &&
                  (Lt.delete(this._expressions.getValue(i)),
                  this._expressions.setValue(i, null)),
                  this._expressions.setValue(i, r),
                  this._expressionCount++,
                  this._expressionCount >= t &&
                    ((this._state = hs.LoadPhysics), s());
              });
          }
          this._state = hs.WaitLoadExpression;
        } else (this._state = hs.LoadPhysics), s();
      },
      s = () => {
        if ("" != this._modelSetting.getPhysicsFileName()) {
          ...
          fetch(`${this._modelHomeDir}${t}`)
            ...
            .then((t) => {
              this.loadPhysics(t, t.byteLength),
                (this._state = hs.LoadPose),
                r();
            }),
            (this._state = hs.WaitLoadPhysics);
        } else (this._state = hs.LoadPose), r();
      },
      r = () => {
        if ("" != this._modelSetting.getPoseFileName()) {
          ...
          fetch(`${this._modelHomeDir}${t}`)
            ...
            .then((t) => {
              this.loadPose(t, t.byteLength),
                (this._state = hs.SetupEyeBlink),
                a();
            }),
            (this._state = hs.WaitLoadPose);
        } else (this._state = hs.SetupEyeBlink), a();
      },
      a = () => {
        this._modelSetting.getEyeBlinkParameterCount() > 0 &&
          ((this._eyeBlink = St.create(this._modelSetting)),
          (this._state = hs.SetupBreath)),
          n();
      },
      n = () => {
        this._breath = ft.create();
        const t = new e();
        t.pushBack(new yt(this._idParamAngleX, 0, 15, 6.5345, 0.5)),
          ...
          t.pushBack(
            new yt($.getIdManager().getId(ot.ParamBreath), 0.5, 0.5, 3.2345, 1)
          ),
          this._breath.setParameters(t),
          (this._state = hs.LoadUserData),
          o();
      },
      o = () => {
        if ("" != this._modelSetting.getUserDataFile()) {
          ...
          fetch(`${this._modelHomeDir}${t}`)
            ...
            .then((t) => {
              this.loadUserData(t, t.byteLength),
                (this._state = hs.SetupEyeBlinkIds),
                l();
            }),
            (this._state = hs.WaitLoadUserData);
        } else (this._state = hs.SetupEyeBlinkIds), l();
      },
      l = () => {
        const t = this._modelSetting.getEyeBlinkParameterCount();
        for (let e = 0; e < t; ++e)
          this._eyeBlinkIds.pushBack(
            this._modelSetting.getEyeBlinkParameterId(e)
          );
        (this._state = hs.SetupLipSyncIds), h();
      },
      h = () => {
        const t = this._modelSetting.getLipSyncParameterCount();
        for (let e = 0; e < t; ++e)
          this._lipSyncIds.pushBack(
            this._modelSetting.getLipSyncParameterId(e)
          );
        (this._state = hs.SetupLayout), u();
      },
      u = () => {
        const t = new I();
        null != this._modelSetting && null != this._modelMatrix
          ? (this._modelSetting.getLayoutMap(t),
            ...
            (this._state = hs.LoadMotion),
            g())
          : b("Failed to setupLayout().");
      },
      g = () => {
        (this._state = hs.WaitLoadMotion),
          this._model.saveParameters(),
  ...
  setupTextures() {
    ...
    if (this._state == hs.LoadTexture) {
      ...
      for (let i = 0; i < e; i++) {
        ...
        const r = (t) => {
          this.getRenderer().bindTexture(i, t.id),
            this._textureCount++,
            this._textureCount >= e && (this._state = hs.CompleteSetup);
        };
        this._subdelegate.getTextureManager().createTextureFromPngFile(s, t, r),
          this.getRenderer().setIsPremultipliedAlpha(t);
      }
  ...
  startMotion(t, e, i, s, r) {
    if (3 == i) this._motionManager.setReservePriority(i);
    else if (!this._motionManager.reserveMotion(i))
      return this._debugMode && at.printMessage("[APP]can't start motion."), Yt;
    const a = this._modelSetting.getMotionFileName(t, e),
      n = `${t}_${e}`;
    let o = this._motions.getValue(n),
      l = !1;
    if (null == o) {
      if (
        (fetch(`${this._modelHomeDir}${a}`)
          .then((t) =>
            t.ok
              ? t.arrayBuffer()
              : t.status >= 400
              ? (b(`Failed to load file ${this._modelHomeDir}${a}`),
                new ArrayBuffer(0))
              : void 0
          )
          .then((i) => {
    ...
    return (
      this._debugMode && at.printMessage(`[APP]start motion: [${t}_${e}]`),
      this._motionManager.startMotionPriority(o, l, i)
    );
  }
  startRandomMotion(t, e, i, s) {
    if (0 == this._modelSetting.getMotionCount(t)) return Yt;
    const r = Math.floor(Math.random() * this._modelSetting.getMotionCount(t));
    return this.startMotion(t, r, e, i, s);
  }
  setExpression(t) {
    const e = this._expressions.getValue(t);
    this._debugMode && at.printMessage(`[APP]expression: [${t}]`),
      null != e
        ? this._expressionManager.startMotion(e, !1)
        : this._debugMode && at.printMessage(`[APP]expression[${t}] is null`);
  }
  setRandomExpression() {
    ...
    for (let e = 0; e < this._expressions.getSize(); e++)
      if (e == t) {
        const t = this._expressions._keyValues[e].first;
        return void this.setExpression(t);
      }
  }
  motionEventFired(t) {
  ...
  hitTest(t, e, i) {
    ...
    // Model may not be fully initialized yet; bail out safely
    if (!this._modelSetting) return !1;
    let s = 0;
    try {
      if (typeof this._modelSetting.getHitAreasCount === 'function') s = this._modelSetting.getHitAreasCount();
      else if (typeof this._modelSetting.getHitAreaNum === 'function') s = this._modelSetting.getHitAreaNum();
      else s = 0;
    } catch (err) {
      return !1;
    }
    for (let r = 0; r < s; r++) {
      let name = null;
      try {
        if (typeof this._modelSetting.getHitAreaName === 'function') name = this._modelSetting.getHitAreaName(r);
        else if (typeof this._modelSetting.getHitArea === 'function') name = this._modelSetting.getHitArea(r);
      } catch (err) {
        continue;
      }
      if (name == t) {
        let id = null;
        try {
          if (typeof this._modelSetting.getHitAreaId === 'function') id = this._modelSetting.getHitAreaId(r);
          else if (typeof this._modelSetting.getHitAreaID === 'function') id = this._modelSetting.getHitAreaID(r);
        } catch (err) {
          id = null;
        }
        if (id) return this.isHit(id, e, i);
      }
    }
    return !1;
  }
  preLoadMotionGroup(t) {
    for (let e = 0; e < this._modelSetting.getMotionCount(t); e++) {
      const i = this._modelSetting.getMotionFileName(t, e),
        s = `${t}_${e}`;
      this._debugMode && at.printMessage(`[APP]load motion: ${i} => [${s}]`),
          ...
          .then((i) => {
            ...
            null != r
              ? (r.setEffectIds(this._eyeBlinkIds, this._lipSyncIds),
                null != this._motions.getValue(s) &&
                  Lt.delete(this._motions.getValue(s)),
  ...
  async hasMocConsistencyFromFile() {
    if (
      (C(this._modelSetting.getModelFileName().localeCompare("")),
      "" != this._modelSetting.getModelFileName())
    ) {
      const t = this._modelSetting.getModelFileName(),
        e = await fetch(`${this._modelHomeDir}${t}`),
        i = await e.arrayBuffer();
      return (
        (this._consistency = Ji.hasMocConsistency(i)),
        this._consistency ? M("Consistent MOC3.") : M("Inconsistent MOC3."),
        this._consistency
      );
    }
  ...
  constructor() {
    super(),
      ...
      (this._userTimeSeconds = 0),
      (this._eyeBlinkIds = new e()),
      (this._lipSyncIds = new e()),
      (this._motions = new I()),
      (this._expressions = new I()),
      (this._hitArea = new e()),
      (this._userArea = new e()),
      (this._idParamAngleX = $.getIdManager().getId(ot.ParamAngleX)),
      (this._idParamAngleY = $.getIdManager().getId(ot.ParamAngleY)),
      (this._idParamAngleZ = $.getIdManager().getId(ot.ParamAngleZ)),
      (this._idParamEyeBallX = $.getIdManager().getId(ot.ParamEyeBallX)),
      (this._idParamEyeBallY = $.getIdManager().getId(ot.ParamEyeBallY)),
      (this._idParamBodyAngleX = $.getIdManager().getId(ot.ParamBodyAngleX)),
      (this._mocConsistency = !0),
      (this._motionConsistency = !0),
      (this._state = hs.LoadAssets),
      (this._expressionCount = 0),
      (this._textureCount = 0),
      (this._motionCount = 0),
      (this._allMotionCount = 0),
      (this._wavFileHandler = new ns()),
      (this._consistency = !1);
  }
}
class ds {
  ...
  changeScene(t) {
    ...
    const s = new gs();
    s.setSubdelegate(this._subdelegate),
      s.loadAssets(e, i),
      this._models.pushBack(s);
  }
  setViewMatrix(t) {
    for (let e = 0; e < 16; e++)
...
class _s {
  ...
  createTextureFromPngFile(t, e, i) {
    for (
      ...
      if (s.ptr().fileName == t && s.ptr().usePremultply == e)
        return (
          ...
          s
            .ptr()
            .img.addEventListener("load", () => i(s.ptr()), { passive: !0 }),
    ...
    s.addEventListener(
      "load",
      () => {
        const r = this._glManager.getGl().createTexture();
        this._glManager
          .getGl()
          .bindTexture(this._glManager.getGl().TEXTURE_2D, r),
          this._glManager
            .getGl()
            .texParameteri(
        ...
        null != a &&
          ...
          (a.img = s),
          (a.usePremultply = e),
          null != this._textures && this._textures.pushBack(a)),
          i(a);
      },
      { passive: !0 }
    ),
...
class ms extends c {
  ...
  adjustScale(t, e, i) {
    ...
    c.multiply(l, this._tr, this._tr),
      c.multiply(o, this._tr, this._tr),
      c.multiply(n, this._tr, this._tr);
  }
...
class ps {
  constructor(t, e, i, s, r) {
    (this._rect = new fs()),
      ...
      (this._rect.up = e + 0.5 * s),
      (this._rect.down = e - 0.5 * s),
      (this._texture = r),
    ...
    if (this._firstDraw) {
        ...
        (this._uvBuffer = e.createBuffer());
      {
        const t = this._subdelegate.getCanvas().width,
          i = this._subdelegate.getCanvas().height;
        (this._positionArray = new Float32Array([
          (this._rect.right - 0.5 * t) / (0.5 * t),
          (this._rect.up - 0.5 * i) / (0.5 * i),
          (this._rect.left - 0.5 * t) / (0.5 * t),
          (this._rect.up - 0.5 * i) / (0.5 * i),
          (this._rect.left - 0.5 * t) / (0.5 * t),
          (this._rect.down - 0.5 * i) / (0.5 * i),
          (this._rect.right - 0.5 * t) / (0.5 * t),
          (this._rect.down - 0.5 * i) / (0.5 * i),
        ])),
...
class Ss {
  constructor() {
    (this._programId = null),
      (this._back = null),
      (this._gear = null),
      (this._touchManager = new ys()),
      (this._deviceToScreen = new c()),
      (this._viewMatrix = new ms());
  }
  initialize(t) {
    this._subdelegate = t;
    const { width: e, height: i } = t.getCanvas(),
      ...
      a = s;
    if (
      (this._viewMatrix.setScreenRect(r, a, -1, 1),
      ...
      const t = Math.abs(2);
      this._deviceToScreen.scaleRelative(t / i, -t / i);
    }
    this._deviceToScreen.translateRelative(0.5 * -e, 0.5 * -i),
  ...
  initializeSprite() {
    ...
    i.createTextureFromPngFile(s + r, !1, (i) => {
      const s = 0.5 * t,
        r = 0.5 * e,
        a = 2 * i.width,
        n = 0.95 * e;
      (this._back = new ps(s, r, a, n, i.id)),
        this._back.setSubdelegate(this._subdelegate);
    }),
      (r = "icon_gear.png");
    i.createTextureFromPngFile(s + r, !1, (i) => {
      const s = t - 0.5 * i.width,
        r = e - 0.5 * i.height,
        a = i.width,
        n = i.height;
      (this._gear = new ps(s, r, a, n, i.id)),
...
class Cs {
  constructor() {
    (this._canvas = null),
      (this._glManager = new nt()),
      (this._textureManager = new _s()),
      (this._live2dManager = new ds()),
      (this._view = new Ss()),
  ...
  initialize(t) {
    ...
    return (
      ...
      (this._resizeObserver = new ResizeObserver((t, e) =>
        this.resizeObserverCallback.call(this, t, e)
      )),
  ...
  createShader() {
    ...
    if (null == e)
      return at.printMessage("failed to create vertexShader"), null;
    t.shaderSource(
      e,
    ...
    if (null == i)
      return at.printMessage("failed to create fragmentShader"), null;
    t.shaderSource(
      i,
  ...
  onPointEnded(t, e) {
    if (((this._captured = !1), !this._view))
      return void at.printMessage("view notfound");
    const i = t - this._canvas.offsetLeft,
      s = e - this._canvas.offsetTop;
...
class Ms {
  ...
  run() {
    const t = () => {
      if (null != xs) {
        at.updateTime();
        for (let t = 0; t < this._subdelegates.getSize(); t++)
          this._subdelegates.at(t).update();
  ...
  initializeCubism() {
    at.updateTime(),
      (this._cubismOption.logFunction = at.printMessage),
      (this._cubismOption.loggingLevel = rt),
      $.startUp(this._cubismOption),
      $.initialize();
  }
  initializeSubdelegates() {
    ...
    for (let t = 0; t < 1; t++) {
      ...
      this._canvases.pushBack(t),
        (t.style.width = "100vw"),
        (t.style.height = "100vh"),
        document.body.appendChild(t);
    }
    for (let t = 0; t < this._canvases.getSize(); t++) {
      const e = new Cs();
      e.initialize(this._canvases.at(t)), this._subdelegates.pushBack(e);
    }
    for (let t = 0; t < 1; t++)
      this._subdelegates.at(t).isContextLost() &&
        b(
          `The context for Canvas at index ${t} was lost, possibly because the acquisition limit for WebGLRenderingContext was reached.`
        );
  }
  constructor() {
    (this._cubismOption = new Z()),
      (this._subdelegates = new e()),
      (this._canvases = new e());
  }
}
at.printMessage = () => {};
class vs extends Cs {
  initialize(t) {
    ...
    return (
      ...
      (this._resizeObserver = new window.ResizeObserver((t, e) =>
        this.resizeObserverCallback.call(this, t, e)
      )),
      this._resizeObserver.observe(this._canvas),
      !0
...
class bs extends Ms {
  run() {
    const t = () => {
      ...
      for (let t = 0; t < this._subdelegates.getSize(); t++)
        this._subdelegates.at(t).update();
      this._drawFrameId = window.requestAnimationFrame(t);
    };
    t();
  }
  stop() {
  ...
  transformOffset(t) {
    ...
    return { x: e._view.transformViewX(a), y: e._view.transformViewY(n) };
  }
  onMouseMove(t) {
    const e = this._subdelegates.at(0).getLive2DManager(),
      { x: i, y: s } = this.transformOffset(t),
      r = e._models.at(0);
    e.onDrag(i, s),
      e.onTap(i, s),
      r.hitTest(st, i, s) &&
  ...
  initializeSubdelegates() {
    ...
    this._canvases.pushBack(e),
      (e.style.width = e.width),
      (e.style.height = e.height);
    for (let e = 0; e < this._canvases.getSize(); e++) {
      const i = new vs();
      if (!i.initialize(this._canvases.at(e)))
        return void t.error("Failed to initialize AppSubdelegate");
      this._subdelegates.pushBack(i);
    }
    for (let e = 0; e < 1; e++)
      this._subdelegates.at(e).isContextLost() &&
        t.error(
          `The context for Canvas at index ${e} was lost, possibly because the acquisition limit for WebGLRenderingContext was reached.`
        );
  }
  changeModel(t) {
    const e = t.split("/"),
